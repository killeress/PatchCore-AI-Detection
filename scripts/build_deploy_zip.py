...
CODE_FILES = [
    ...
    "templates/scratch_management.html",
    ...
    "templates/train_new/_auto_exclude.html",
    ...
    "scripts/over_review_poc/__init__.py",
    "scripts/over_review_poc/dataset.py",
    "scripts/over_review_poc/features.py",
    "scripts/over_review_poc/finetune_lora.py",
    "scripts/over_review_poc/splits.py",
    "scripts/over_review_poc/zero_leak_analysis.py",
    "scripts/over_review_poc/evaluate.py",
    "tools/merge_over_review_manifests.py",
