    ...
    for result in results:
        ...
        for tile, score, anomaly_map in result.anomaly_tiles:
            ...
            img_data["tiles"].append({
                ...
                "aoi_image_x": getattr(tile, "aoi_image_x", -1),
                "aoi_image_y": getattr(tile, "aoi_image_y", -1),
                "aoi_tile_shift_dx": getattr(tile, "aoi_tile_shift_dx", 0),
                "aoi_tile_shift_dy": getattr(tile, "aoi_tile_shift_dy", 0),
