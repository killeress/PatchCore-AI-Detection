...
|---|---|---|---|---|---|
| **LoRA r=8 / 2 blocks / 10 ep + cl=4 + cls** | **89.4% ± 6.0%** | **98.3% ± 1.5%** | **80.8% ± 12.4%** 🎯 | **0.937** | **1.7%** |

2/5 folds 達 100% realistic（fold 3 + fold 1 Oracle 86.4%）。172K 可訓練參數（base 86M 完全凍結）。
...
**LoRA r=8 / 2 blocks / 10 epochs + CLAHE cl=4**（cls token）：
- Realistic 89.4% / true_ng 98.3% / **Oracle 80.8%** / PR-AUC 0.937
- 相對 v1 baseline：Realistic +1.7%、Oracle **+14.1%**、漏檢從 3.3% 降到 **1.7%**
